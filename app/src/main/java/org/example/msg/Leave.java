 ...
 */
public class Leave {
    /** This class represents the message for beginning a leave operation. */
    public static class InitiateMsg implements Serializable {};

    /** This class represents the message for announcing that the leaving node is leaving. */
    ...
    /** This class represents the message for giving the leaving node items to their new responsible nodes. */
    ...
    /** This class represents the message for informing the leaving node that the new responsible stored its data items. */
    public static class AckMsg implements Serializable {};

    /** This class represents the message for failing the leaving operation. */
